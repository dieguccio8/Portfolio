...
export default function App() {
  ...
  return (
    <SmoothScroll>
      ...
      {/* SECTION 4: INLINE CONTACT / GET IN TOUCH (Based on uploaded layout with elegant glassmorphic form, pure dark background, white text) */}
      <section className="relative w-full bg-[#050505] text-white py-24 sm:py-32 md:py-40 px-6 sm:px-10 md:px-14 border-t border-white/5 overflow-hidden" id="direct-contact-section">
