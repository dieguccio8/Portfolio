...
export const Button3D = () => {
  return (
    <div className={cn("flex flex-col items-center justify-center p-4 rounded-lg")}>
        ...
        <div className="wrap">
          ...
          <div className="content">
            <span className="char state-1">
              <span data-label="P" style={{ "--i": 1 } as any}>P</span>
              <span data-label="r" style={{ "--i": 2 } as any}>r</span>
              <span data-label="o" style={{ "--i": 3 } as any}>o</span>
              <span data-label="v" style={{ "--i": 4 } as any}>v</span>
